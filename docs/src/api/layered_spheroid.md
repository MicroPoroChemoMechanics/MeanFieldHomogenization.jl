...
MeanFieldHomogenization.LayeredSpheroids.confocal_layer_radii
...
MeanFieldHomogenization.LayeredSpheroids.AxisymmetricCase
MeanFieldHomogenization.LayeredSpheroids.spheroid_elastic_coefficients
MeanFieldHomogenization.LayeredSpheroids.spheroid_core_strain
MeanFieldHomogenization.LayeredSpheroids.TransverseShearCase
MeanFieldHomogenization.LayeredSpheroids.LongitudinalShearCase
MeanFieldHomogenization.LayeredSpheroids.ModeGroup
MeanFieldHomogenization.LayeredSpheroids.PNMode
MeanFieldHomogenization.LayeredSpheroids.bb_letter
MeanFieldHomogenization.LayeredSpheroids.mode_fields
MeanFieldHomogenization.LayeredSpheroids.spheroid_strain_concentration
MeanFieldHomogenization.LayeredSpheroids.spheroid_layer_strain_concentration
```
