...
whereas the reference's Eq. (12) damps that response. Same mechanisms, same
...
- **Reproduced**: the microstructure, the joint poroelastic and hydraulic
  ...
  conclusion of § 3.2.
- **Not reproduced**: the self-consistent permeability of Eq. (12), which
  ...
  but differ by ≈ 55 on the level and ≈ 2 on the sensitivity. Eq. (12) is not
  transcribed here because Eqs. (13)–(15) that define it are, in the copy at
